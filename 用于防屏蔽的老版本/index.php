				...
				<div class="row">
					...
					<div class="contact-details">
							...
							<div class="con-info clearfix">
								...
								<span>社长电话：18345555646 </span>
							</div>
							
							
							<div class="con-info clearfix">
								<i class="fa fa-envelope fa-lg"></i>
								<span><p onClick="window.location.href='tencent://message/?uin=2529384400&Menu=yes';">社长qq号：2529384400&nbsp;&nbsp;<i class="fa fa-long-arrow-left fa-lg" style="float: right;margin-top: 5px"></i></p>
							</div>
							<div class="con-info clearfix">
								<i class="fa fa-envelope fa-lg"></i>
								<span><p onClick="window.location.href='mqqapi://card/show_pslcard?src_type=internal&version=1&uin=18863883&card_type=group&source=external">社团qq群：178373191&nbsp;&nbsp;<i class="fa fa-long-arrow-left fa-lg" style="float: right;margin-top: 5px"></i></p>
