		...
		<div class="top_nav">
			...
			<div class="top_nav_xm">
				<div class="navtit" id="navtit">
					...
					<span onclick="changeMenu(this);"><a href="index.left.php?menu=special" target='leftFrame'><i>社团特色修改</i></a></span>
					<span onclick="changeMenu(this);"><a href="index.left.php?menu=aboutus" target='leftFrame'><i>关于我们修改</i></a></span>
					<span onclick="changeMenu(this);"><a href="index.left.php?menu=album" target='leftFrame'><i>社团相册修改</i></a></span>
					<span onclick="changeMenu(this);"><a href="index.left.php?menu=problem" target='leftFrame'><i>常见问题修改</i></a></span>
					<span onclick="changeMenu(this);"><a href="index.left.php?menu=signup" target='leftFrame'><i>报名信息查看</i></a></span>
					<span onclick="changeMenu(this);"><a href="index.left.php?menu=message" target='leftFrame'><i>留言查看</i></a></span>
