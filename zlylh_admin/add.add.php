...
<body>
	<div id="wrap">
		<div class="tab">
			<ul>
				<li><a href="add.add.php">地址管理</a>
				</li>
				<li><a href="javascript:void(0);" class="on">添加地址</a>
				</li>
			</ul>
		</div>
		<div class="main">
			...
			<form action="add_check.php" method="post" name="myform" class="demoform">
				<table cellspacing="0" class="sub">
					...
					<tr>
						...
						<td><input name="name" type="text" value="还未选择地址" id="sever_add" readonly>
						</td>
						<td></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input name="tel" type="text" id="tel" value="" size="20"/>
						</td>
						<td></td>
					</tr>
					<tr>
						<td width="100" align="right">联系人姓名：</td>
						<td><input name="peo" type="text" id="peo" value="" size="20"/>
						</td>
						<td></td>
					</tr>
					<tr class="bg2">
...
<script src="js/ajax_add.add.js"></script>
