...
function GetJcrop(frame, input)
{
	...
	$("body").append('<iframe frameborder="0" id="'+ frame +'" src="../../zlylh_admin/data/plugin/jcrop/index.php?imgurl='+ encodeURI(imgurl) +'&frame='+ frame +'&input='+ input +'" allowtransparency="true" class="uploadframe" scrolling="no"></iframe>');
