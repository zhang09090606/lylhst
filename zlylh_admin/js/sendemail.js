...
function send_email_done(){
	if(xmlHttp.readyState == 1){
		document.getElementById('emailmsg').innerHTML = '<br /><div class="loading"><img src="..//js/template/images/loading.gif">邮件发送中...</div>';
	}
