$(document).ready(function(){
	...
	$('#bj_name').blur(function(){
		if($(this).val()==''){
			...
			$('#bj_name_error').html("<img src='..//js/images/onCorrect.gif' />");
		}
	});	
	...
	$('#bj_dj').blur(function(){
		if($(this).val()==''){
			...
			$('#bj_dj_error').html("<img src='..//js/images/onCorrect.gif' />");
		}
	});
	...
	$('#bj_type').blur(function(){
		if($(this).val()==''){
			...
			$('#bj_type_error').html("<img src='..//js/images/onCorrect.gif' />");
		}
	});
	...
	$('#bj_ccnx').blur(function(){
		if($(this).val()==''){
			...
			$('#bj_ccnx_error').html("<img src='..//js/images/onCorrect.gif' />");
		}
	});
	...
	$('#bj_comes').blur(function(){
		if($(this).val()==''){
			...
			$('#bj_comes_error').html("<img src='..//js/images/onCorrect.gif' />");
		}
	});
	...
	$('#bj_jg').blur(function(){
		if($(this).val()==''){
			...
			$('#bj_jg_error').html("<img src='..//js/images/onCorrect.gif' />");
		}
	});
	...
	$('#bj_address').blur(function(){
		if($(this).val()==''){
			...
			$('#bj_address_error').html("<img src='..//js/images/onCorrect.gif' />");
		}
	});
});