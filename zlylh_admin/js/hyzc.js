...
/*	
	...
	$('#user').blur(function(){
		if($(this).val()==''){
			...
			$('#user_error').html("<img src='..//js/images/onCorrect.gif' />");
		}
	});
	...
	$('#password').blur(function(){
		if($(this).val()==''){
			...
			$('#password_error').html("<img src='..//js/images/onCorrect.gif' />");
		}
	});
	...
	$('#repassword').blur(function(){
		...
		$('#repassword_error').html("<img src='..//js/images/onCorrect.gif' />");
		}
	});
/*	var email = document.my.email.value;
	...
	$('#email').blur(function(){
		...
		$('#email_error').html("<img src='..//js/images/onCorrect.gif' />");
	});
