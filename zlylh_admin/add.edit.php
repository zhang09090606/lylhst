...
<body>
	<div id="wrap">
		...
		<div class="main">
			...
			<form action="add_check.php" method="post" name="myform" class="demoform">
				<table cellspacing="0" class="sub">
					...
					<tr>
						...
						<td><input name="name" type="text" value="<?php echo $row['addname'] ?>" id="sever_add" readonly>
						</td>
						<td></td>
					</tr>
					<tr>
						<td width="100" align="right">详细地址：</td>
						<td><input name="inf" type="text" id="inf" value="<?php echo $row['inf'] ?>" size="20"/>
						</td>
						<td></td>
					</tr>
					<tr>
						<td width="100" align="right">用户联系电话：</td>
						<td><input name="tel" type="text" id="tel" value="<?php echo $row['tel'] ?>" size="20"/>
						</td>
						<td></td>
					</tr>
					<tr>
						<td width="100" align="right">联系人姓名：</td>
						<td><input name="peo" type="text" id="peo" value="<?php echo $row['peo'] ?>" size="20"/>
						</td>
						<td></td>
					</tr>
					<tr class="bg2">
	...
	<script type="text/javascript">
		...
		var point = new BMap.Point( <?php echo $row['lng']?>, <?php echo $row['lat'] ?> );
