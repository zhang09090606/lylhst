...
<body>
	<div id="wrap">
		...
		<div class="main">
			...
			<form action="order_check.php?id=<?php echo $id?>" method="post" name="myform" class="demoform">
				<table cellspacing="0" class="sub">
					...
					<tr <?php if($id==2){echo "hidden";}?>>
						<td width="100" align="right">回收者用户名：</td>
						<td><input name="hsuser" type="text" id="hsuser" value="" size="20"/>
						</td>
						<td></td>
					</tr>
					<tr class="bg2">
