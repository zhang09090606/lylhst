...
class MyDb
{
    ...
    public function __construct($dbname,$host="bdm258658313.my3w.com",$user="bdm258658313",$pwd="zhang986",$charset="SET NAMES UTF8")
    {
        //初始化成员变量
        $this->dbname = $dbname;
        $this->host = $host;
   ...
   */
   public  function get_one($table,$where,$coment="*")
     ...
     * @return string   前缀+表名
     */
    private  function getTableName($tableName,$tablePrifx="zlh_")
    {
